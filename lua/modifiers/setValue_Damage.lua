...
local _setValue_attack1DamageSpellBuffMultiplier = {}
local _setValue_attack2DamageSpellBuffMultiplier = {}
function svSetAttack1DamageInit(unit, floatPart, addedValuesMultiplier, spellBuffMutiplier)
	...
	_setValue_attack1DamageSpellBuffMultiplier[uid] = spellBuffMutiplier
	return 0
end
function svSetAttack2DamageInit(unit, floatPart, addedValuesMultiplier, spellBuffMutiplier)
	local uid = unit.id.value
	_setValue_attack2DamageFloatPart[uid] = floatPart
	_setValue_attack2DamageAddedValuesMultiplier[uid] = addedValuesMultiplier
	_setValue_attack2DamageSpellBuffMultiplier[uid] = spellBuffMutiplier
	return 0
end
...
function svMultimplyDamage1_Spell(unit, prev, multiplier)
	local uid = unit.id.value
	return svMultimplyDamage1(unit, prev, multiplier * _setValue_attack1DamageSpellBuffMultiplier[uid])
end

function svMultimplyDamage2_Spell(unit, prev, multiplier)
	local uid = unit.id.value
	return svMultimplyDamage2(unit, prev, multiplier * _setValue_attack2DamageSpellBuffMultiplier[uid])
end
