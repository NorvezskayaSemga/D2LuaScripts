...
local _setValue_attack1HealSpellBuffMultiplier = {}
local _setValue_attack2HealSpellBuffMultiplier = {}
function svSetAttack1HealInit(unit, floatPart, addedValuesMultiplier, spellBuffMutiplier)
	...
	_setValue_attack1HealSpellBuffMultiplier[uid] = spellBuffMutiplier
	return 0
end
function svSetAttack2HealInit(unit, floatPart, addedValuesMultiplier, spellBuffMutiplier)
	local uid = unit.id.value
	_setValue_attack2HealFloatPart[uid] = floatPart
	_setValue_attack2HealAddedValuesMultiplier[uid] = addedValuesMultiplier
	_setValue_attack2HealSpellBuffMultiplier[uid] = spellBuffMutiplier
	return 0
end
...
function svMultimplyHeal1_Spell(unit, prev, multiplier)
	local uid = unit.id.value
	return svMultimplyHeal1(unit, prev, multiplier * _setValue_attack1HealSpellBuffMultiplier[uid])
end

function svMultimplyHeal2_Spell(unit, prev, multiplier)
	local uid = unit.id.value
	return svMultimplyHeal2(unit, prev, multiplier * _setValue_attack2HealSpellBuffMultiplier[uid])
end
