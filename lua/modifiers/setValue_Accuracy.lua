...
local _setValue_attack1PowerSpellBuffMultiplier = {}
local _setValue_attack2PowerSpellBuffMultiplier = {}
...
function svSetAttack1PowerInit(unit, floatPart, addedValuesMultiplier, spellBuffMutiplier)
	local uid = unit.id.value
	...
	_setValue_attack1PowerSpellBuffMultiplier[uid] = spellBuffMutiplier
	return 0
end
function svSetAttack2PowerInit(unit, floatPart, addedValuesMultiplier, spellBuffMutiplier)
	local uid = unit.id.value
	...
	_setValue_attack2PowerSpellBuffMultiplier[uid] = spellBuffMutiplier
	return 0
end
...
function svMultimplyPower1_Spell(unit, prev, multiplier)
	local uid = unit.id.value
	return svMultimplyPower1(unit, prev, multiplier * _setValue_attack1PowerSpellBuffMultiplier[uid])
end

function svMultimplyPower2_Spell(unit, prev, multiplier)
	local uid = unit.id.value
	return svMultimplyPower2(unit, prev, multiplier * _setValue_attack2PowerSpellBuffMultiplier[uid])
end
