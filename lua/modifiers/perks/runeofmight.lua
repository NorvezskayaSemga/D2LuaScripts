...
myModValue = Id.new('g200um0012').value
...
function getAttackDamage(unit, prev)
	return svMultimplyDamage1(unit, prev, 0.33)
end

function getAttackHeal(unit, prev)
	return svMultimplyHeal1(unit, prev, 0.33)
end

function getAttack2Damage(unit, prev)
	return svMultimplyDamage2(unit, prev, 0.33)
end

function getAttack2Heal(unit, prev)
	return svMultimplyHeal2(unit, prev, 0.33)
end
