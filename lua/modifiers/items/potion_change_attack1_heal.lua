...
AttackNameID = Id.new("x000tg5011")
...
function getAttackClass(unit, prev)
	...
	_changeAttackClass_Heal1(unit, prev)
	return AttackClass
end

function getAttack2Id(unit, prev)
	return _changeAttackClass_Heal1_Attack2(unit, prev)
end

function getAttackDrSplit(unit, prev)
	return _changeAttackClass_Heal1_Split(unit, prev)
end
