...
function getAttackDrain(unit, damage, prev)
    return svAddDrain1(unit, prev, damage, 0.46)
end
...
function getAttackCritDamage(unit, prev)
    return svAddCrit1Damage(unit, prev, 46)
end

function getAttack2Drain(unit, damage, prev)
    return svAddDrain2(unit, prev, damage, 0.46)
end
...
function getAttack2CritDamage(unit, prev)
    return svAddCrit2Damage(unit, prev, 46)
end
