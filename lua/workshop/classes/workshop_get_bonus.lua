...
function Workshop_GetBonusSum(scen, unit,
                              ...
                              constantStatsBonus, yourTerrainStatsBonus, opponentTerrainStatsBonus, neutralTerrainStatsBonus, perLostHPStatsBonus, perDifferentUnitStatsBonus, perIdenticalUnitStatsBonus, perUnitLevelBonus, perGroupLevelsSumBonus, 
                              constantStatsBonusLeaderType, yourTerrainStatsBonusLeaderType, opponentTerrainStatsBonusLeaderType, neutralTerrainStatsBonusLeaderType, perLostHPStatsBonusLeaderType, perDifferentUnitStatsBonusLeaderType, perIdenticalUnitStatsBonusLeaderType, perUnitLevelBonusLeaderType, perGroupLevelsSumBonusLeaderType)
	...
	if perIdenticalUnitStatsBonus ~= 0 or perIdenticalUnitStatsBonusLeaderType ~= 0 then
	...
	if perUnitLevelBonus ~= 0 or perUnitLevelBonusLeaderType ~= 0 then
		result = result + unit.impl.level * ( perUnitLevelBonus + perUnitLevelBonusLeaderType )
	end
	if perGroupLevelsSumBonus ~= 0 or perGroupLevelsSumBonusLeaderType ~= 0 then
		local levelsSum = 0
		local units = group.units
		for i=1, #units do
			levelsSum = levelsSum + units[i].impl.level
		end
		result = result + levelsSum * ( perGroupLevelsSumBonus + perGroupLevelsSumBonusLeaderType )
	end
	return result
end
...
function Workshop_getBonus_baseHitPoint_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseHitPoint_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseHitPoint_Percent()
   ...
   local perUnitLevelBonusLeaderType = 0
   local perGroupLevelsSumBonusLeaderType = 0
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseHitPoint_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseHitPoint_Percent()
   end
...
function Workshop_getBonus_baseAttack1Power_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseAttack1Power_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseAttack1Power_Percent()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseAttack1Power_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseAttack1Power_Percent()
   end
...
function Workshop_getBonus_baseAttack2Power_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseAttack2Power_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseAttack2Power_Percent()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseAttack2Power_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseAttack2Power_Percent()
   end
...
function Workshop_getBonus_baseAttack1Damage_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseAttack1Damage_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseAttack1Damage_Percent()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseAttack1Damage_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseAttack1Damage_Percent()
   end
...
function Workshop_getBonus_baseAttack2Damage_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseAttack2Damage_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseAttack2Damage_Percent()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseAttack2Damage_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseAttack2Damage_Percent()
   end
...
function Workshop_getBonus_baseAttack1Heal_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseAttack1Heal_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseAttack1Heal_Percent()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseAttack1Heal_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseAttack1Heal_Percent()
   end
...
function Workshop_getBonus_baseAttack2Heal_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseAttack2Heal_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseAttack2Heal_Percent()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseAttack2Heal_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseAttack2Heal_Percent()
   end
...
function Workshop_getBonus_baseAttackInitiative_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseAttackInitiative_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseAttackInitiative_Percent()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseAttackInitiative_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseAttackInitiative_Percent()
   end
...
function Workshop_getBonus_baseRegen_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseRegen_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseRegen_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseRegen_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseRegen_Flat()
   end
...
function Workshop_getBonus_baseArmor_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseArmor_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseArmor_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseArmor_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseArmor_Flat()
   end
...
function Workshop_getBonus_baseNegotiate_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_baseNegotiate_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_baseNegotiate_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_baseNegotiate_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_baseNegotiate_Flat()
   end
...
function Workshop_getBonus_XpGain_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_XpGain_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_XpGain_Percent()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_XpGain_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_XpGain_Percent()
   end
...
function Workshop_getBonus_Movement_Percent(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Movement_Percent()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Movement_Percent()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Movement_Percent()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Movement_Percent()
   end
...
function Workshop_getBonus_Movement_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Movement_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Movement_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Movement_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Movement_Flat()
   end
...
function Workshop_getBonus_Attack1CritDamage_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Attack1CritDamage_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Attack1CritDamage_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Attack1CritDamage_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Attack1CritDamage_Flat()
   end
...
function Workshop_getBonus_Attack2CritDamage_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Attack2CritDamage_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Attack2CritDamage_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Attack2CritDamage_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Attack2CritDamage_Flat()
   end
...
function Workshop_getBonus_Attack1CritPower_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Attack1CritPower_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Attack1CritPower_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Attack1CritPower_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Attack1CritPower_Flat()
   end
...
function Workshop_getBonus_Attack2CritPower_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Attack2CritPower_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Attack2CritPower_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Attack2CritPower_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Attack2CritPower_Flat()
   end
...
function Workshop_getBonus_Attack1Drain_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Attack1Drain_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Attack1Drain_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Attack1Drain_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Attack1Drain_Flat()
   end
...
function Workshop_getBonus_Attack2Drain_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Attack2Drain_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Attack2Drain_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Attack2Drain_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Attack2Drain_Flat()
   end
...
function Workshop_getBonus_Scout_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Scout_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Scout_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Scout_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Scout_Flat()
   end
...
function Workshop_getBonus_Leadership_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_Leadership_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_Leadership_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_Leadership_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_Leadership_Flat()
   end
...
function Workshop_getBonus_LowerCost_Flat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_LowerCost_Flat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_LowerCost_Flat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_LowerCost_Flat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_LowerCost_Flat()
   end
...
function Workshop_getBonus_ImmuneToSource_Once(scen, unit, typeKey, gotGroup)
   ...
   local perUnitLevelBonus = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus():get_ImmuneToSource_Once())
   local perGroupLevelsSumBonus = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus():get_ImmuneToSource_Once())
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus(LeaderType):get_ImmuneToSource_Once())
       perGroupLevelsSumBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus(LeaderType):get_ImmuneToSource_Once())
   end
...
function Workshop_getBonus_ImmuneToSource_Always(scen, unit, typeKey, gotGroup)
   ...
   local perUnitLevelBonus = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus():get_ImmuneToSource_Always())
   local perGroupLevelsSumBonus = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus():get_ImmuneToSource_Always())
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus(LeaderType):get_ImmuneToSource_Always())
       perGroupLevelsSumBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus(LeaderType):get_ImmuneToSource_Always())
   end
...
function Workshop_getBonus_ImmuneToAttack_Once(scen, unit, typeKey, gotGroup)
   ...
   local perUnitLevelBonus = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus():get_ImmuneToAttack_Once())
   local perGroupLevelsSumBonus = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus():get_ImmuneToAttack_Once())
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus(LeaderType):get_ImmuneToAttack_Once())
       perGroupLevelsSumBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus(LeaderType):get_ImmuneToAttack_Once())
   end
...
function Workshop_getBonus_ImmuneToAttack_Always(scen, unit, typeKey, gotGroup)
   ...
   local perUnitLevelBonus = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus():get_ImmuneToAttack_Always())
   local perGroupLevelsSumBonus = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus():get_ImmuneToAttack_Always())
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus(LeaderType):get_ImmuneToAttack_Always())
       perGroupLevelsSumBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus(LeaderType):get_ImmuneToAttack_Always())
   end
...
function Workshop_getBonus_LeaderAbility(scen, unit, typeKey, gotGroup)
   ...
   local perUnitLevelBonus = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus():get_LeaderAbility())
   local perGroupLevelsSumBonus = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus():get_LeaderAbility())
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus(LeaderType):get_LeaderAbility())
       perGroupLevelsSumBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus(LeaderType):get_LeaderAbility())
   end
...
function Workshop_getBonus_MoveAbility(scen, unit, typeKey, gotGroup)
   ...
   local perUnitLevelBonus = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus():get_MoveAbility())
   local perGroupLevelsSumBonus = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus():get_MoveAbility())
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perUnitLevelBonus(LeaderType):get_MoveAbility())
       perGroupLevelsSumBonusLeaderType = Workshop_getArrayValue(typeKey, settings:get_perGroupLevelsSumBonus(LeaderType):get_MoveAbility())
   end
...
function Workshop_getBonus_FastRetreat(scen, unit, gotGroup)
   ...
   local perUnitLevelBonus = settings:get_perUnitLevelBonus():get_FastRetreat()
   local perGroupLevelsSumBonus = settings:get_perGroupLevelsSumBonus():get_FastRetreat()
   ...
   if LeaderType ~= nil then
       ...
       perUnitLevelBonusLeaderType = settings:get_perUnitLevelBonus(LeaderType):get_FastRetreat()
       perGroupLevelsSumBonusLeaderType = settings:get_perGroupLevelsSumBonus(LeaderType):get_FastRetreat()
   end
