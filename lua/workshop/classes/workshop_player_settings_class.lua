...
WorkshopPlayer = {race = nil,
		  ...
		  perUnitLevelBonus = nil, 
		  perGroupLevelsSumBonus = nil, 
		  specialSettings = nil}
...
function WorkshopPlayer:init()
   ...
   self.perUnitLevelBonus = WorkshopPlayer_GenCatSettings(1)
   self.perGroupLevelsSumBonus = WorkshopPlayer_GenCatSettings(1)
...
function WorkshopPlayer:get_perUnitLevelBonus(unitType)
   if unitType == nil then
   	unitType = defaultUnitType
   end
   return self.perUnitLevelBonus[unitType]
end
function WorkshopPlayer:set_perUnitLevelBonus(value, unitType)
   if unitType == nil then
   	unitType = defaultUnitType
   end
   self.perUnitLevelBonus[unitType] = value
end

function WorkshopPlayer:get_perGroupLevelsSumBonus(unitType)
   if unitType == nil then
   	unitType = defaultUnitType
   end
   return self.perGroupLevelsSumBonus[unitType]
end
function WorkshopPlayer:set_perGroupLevelsSumBonus(value, unitType)
   if unitType == nil then
   	unitType = defaultUnitType
   end
   self.perGroupLevelsSumBonus[unitType] = value
end
