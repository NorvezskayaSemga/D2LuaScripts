...
local roflomodifier_20230518 = Id.new('g040um0342').value
...
function smnsRoflomodifier_20230518_lowerCost(unit, currentResult)
	...
	local units = group.units
	for i = 1, #units do
		if _GroupInfo_UnitHasModifierValue(units[i], roflomodifier_20230518) and units[i].hp > 0 then
